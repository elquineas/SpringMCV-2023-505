...
<meta charset="UTF-8">
<title>게시판 글쓰기</title>
<link href="${rootPath}/static/css/input.css?2023-01-12-002" rel="stylesheet">
</head>
<body>
	<form class="main" method="POST" enctype="multipart/form-data">
		...
		<div><label>대표이미지</label><input name="b_file" type="file" accept="image/*,audio/*,video/*" /></div>
		<div><label>이미지리스트</label><input name="b_images" type="file" multiple="multiple" accept="image/*" /></div>
		<div class="button-box"><button>저장하기</button></div>
	</form>
	<div>
		<img src="${rootPath}/files/${FILE_NAME}">
